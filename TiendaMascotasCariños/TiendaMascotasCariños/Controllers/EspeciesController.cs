...
namespace TiendaMascotasCariños.Controllers
{
    public class EspeciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EspecieID,Nombre,Descripcion")] Especie especie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EspecieID,Nombre,Descripcion")] Especie especie)
        {
            if (ModelState.IsValid)
            {
